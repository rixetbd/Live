...
Route::middleware('auth')->group(function(){
    ...
    Route::controller(GeneralController::class)->group(function(){
        ...
        Route::get('/admin/database/turncate', 'database_turncate');
    ...
    Route::controller(PackageController::class)->group(function(){
        ...
        Route::post('/admin/package/update', 'package_update')->name('admin.package.update');
    ...
    Route::controller(FaqController::class)->group(function(){
        Route::get('/admin/faq/homepage', 'home_faq')->name('admin.faq.home-faq');
        Route::post('/admin/faq/serviceadd', 'serviceadd')->name('admin.faq.service.add');
        Route::post('/admin/faq/add', 'store')->name('admin.faq.add');
        Route::post('/admin/faq/update', 'update')->name('admin.faq.update');
        Route::get('/admin/faq/destroy/{id}', 'destroy')->name('admin.faq.destroy');
        Route::get('/admin/faq/view/{id}', 'show')->name('admin.faq.view');
        Route::post('/get-faqlist', 'get_faqlist');
    });
