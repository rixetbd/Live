...
<link rel="stylesheet" href="{{asset('final_front_assets/css/home/pricing_31.css')}}">
...
<style>
    ...
    #single_service_sub_nav.tob_sec_bar a,
    #single_service_sub_nav.tob_sec_bar li {
        color: #fff;
        min-width: 170px;
        padding: 2px;
        text-align: center;
    ...
    #single_service_sub_nav.tob_sec_bar a:hover,
    #single_service_sub_nav.tob_sec_bar li:hover {
        color: #383838;
...
<section class="d-none" id="section_service_menu">
    <div class="container">
...
<script src="{{asset('final_front_assets/js/home-script31.js')}}"></script>
<script src="{{asset('final_front_assets/js/pricing_31.js')}}"></script>
