        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card card-success collapsed-card compose-textarea1">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse" style="width: 200px;text-align:end;background: #05af83;">Click here to collapse <i class="fas fa-plus ml-3"></i></button>
                        </div>
                    </div>
                    <div class="card-body" style="display: none;">
                        <textarea id="compose-textarea1" name="overview" class="form-control">{{($service->overview != "" ? $service->overview : "")}}</textarea>
                    </div>
                </div>
                ...
                <div class="card card-success collapsed-card compose-textarea2">
                    ...
                    <div class="card-body" style="display: none;">
                        <textarea id="compose-textarea2" name="description" class="form-control">{{($service->description != "" ? $service->description : "")}}</textarea>
                    </div>
                </div>
                ...
                <div class="card card-success collapsed-card compose-textarea3">
                    ...
                    <div class="card-body" style="display: none;">
                        <textarea id="compose-textarea3" name="why_choose_dimarz" class="form-control">{{($service->why_choose_dimarz != "" ? $service->why_choose_dimarz : "")}}</textarea>
                    </div>
                </div>
                ...
                <div class="card card-success collapsed-card compose-textarea4">
                    ...
                    <div class="card-body" style="display: none;">
                        <textarea id="compose-textarea4" name="faq" class="form-control">{{($service->faq != "" ? $service->faq : "")}}</textarea>
                    </div>
                </div>
