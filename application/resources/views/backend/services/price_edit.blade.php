                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group my-2">
                            ...
                            <input type="number" class="form-control" name="duration[]" placeholder="Days" value="{{$package_info[1]->price}}" required>
                        </div>
                        <div class="input-group my-2">
                            <label for="description" class="w-100">Description</label>
                            <textarea name="info[]" class="form-control" placeholder="Description">{{$package_info[1]->info}}</textarea>
                        </div>
