...
<head>
    ...
    <title>Admin Panel - DiMarz</title>
...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__wobble" src="{{asset('backend_assets')}}/dist/img/logo.png" alt="DiMarz" height="60"
                width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{route('admin.index')}}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">DiMarz</span>
            </a>
              ...
              <i class="fas fa-search fa-fw"></i>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item
                        {{($currentRouteName == "admin.service.index"?"menu-open":" ")}}
                        {{($currentRouteName == "admin.service.create"?"menu-open":" ")}}
                        {{($currentRouteName == "admin.service.category"?"menu-open":" ")}}">
                            <a href="#" class="nav-link">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('admin.service.category')}}" class="nav-link {{($currentRouteName == "admin.service.category"?"active":" ")}}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Category</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{($currentRouteName == "admin.faq.home-faq"?"menu-open":" ")}}">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-umbrella"></i>
                                <p>
                                    FAQ
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('admin.faq.home-faq')}}" class="nav-link {{($currentRouteName == "admin.faq.home-faq"?"active":" ")}}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>FAQ - Home Page</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <footer class="main-footer">
                <strong>Copyright &copy; <script>
                    ...
                    </script> <a href="{{url('/')}}" target="_blank">DiMarz</a>.</strong>
                All rights reserved.
