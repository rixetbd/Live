...
$('#action_menu_item').click(()=>{
    if ($("#action_menu_container").hasClass("d-none")) {
        $('#action_menu_container').removeClass('d-none');
        $('#action_menu_item').addClass('w_100');
        $('#action_menu_item .icon').html('<i class="fas fa-minus"></i>');
    } else {
        $('#action_menu_container').addClass('d-none');
        $('#action_menu_item').removeClass('w_100');
        $('#action_menu_item .icon').html('<i class="fas fa-angle-down"></i>');
    }
});